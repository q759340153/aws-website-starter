        ...
        <div>
          ...
          <form onSubmit={(e) => e.preventDefault()} className="mt-8 flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-2xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-rose-500"
            />
            <button className="px-6 py-3 rounded-2xl bg-rose-600 text-white font-semibold inline-flex items-center justify-center hover:opacity-90 shadow">
